...
Этот проект предоставляет 🚀 **бота**, который собирает звёздную пыль из сервиса с использованием API и отправляет обновления в **Telegram**. Вы можете настроить его на выполнение с произвольным интервалом и отслеживать ваш прогресс со временем.
